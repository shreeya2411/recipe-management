...
try{
	  ...
	  if(rs.next())
	  {
		...
		out.println("<tr>");out.println("<th>dish</th>");out.println("<th>cuisine</th>");out.println("<th>ingredients</th>");out.println("<th>steps</th>");out.println("<th>time</th>");out.println("<th>likes</th>");out.println("<th>cook</th>");out.println("<th>image</th>");out.println("<th>add nutritional data</th>");		out.println("</tr>");
		out.println("</thead>");
		out.println("<tbody>");
		...
		do
		{
		 ...
		 out.println("<td>");%>
		 <form  method="POST" action="nutri" > 
		  <input type="hidden"  name="dishname" value="<%= dishn%>">
			<input type = "text" name="n_data" >
